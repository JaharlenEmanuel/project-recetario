...
export default function Receta() {
  ...
  const { data: suggestionsData, loading: suggestionsLoading } = useFetch(
    selectedMeal
      ? `https://www.themealdb.com/api/json/v1/1/filter.php?c=${selectedMeal.strCategory}`
      : null
  );
    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      {(searchError || detailError) && (
        <div className="text-center py-8">
          <p className="text-red-500 text-lg bg-red-50 px-4 py-2 rounded-lg">
            ...
            {searchError?.message || detailError?.message}
          </p>
        </div>
      )}
      ...
      {!isLoading && selectedMeal && (
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 self-start h-fit">
            <div className="sticky top-6 bg-[#D87800] rounded-lg shadow-lg p-6 w-full">
              <h2 className="text-xl font-bold text-gray-800 mb-4">
